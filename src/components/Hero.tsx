    ...
    <section id="home" className="relative min-h-screen bg-boutique-beige hero-clip flex items-center">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto pt-32 pb-16">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-playfair font-medium text-boutique-black mb-6 opacity-0 animate-fade-in">
            Refined Elegance for the Modern Woman
          </h1>
          <p className="text-boutique-black text-lg md:text-xl mb-10 max-w-xl mx-auto opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Discover our curated collection of timeless pieces designed for everyday luxury and effortless style.
          </p>
          <Button
            className="bg-boutique-black text-white hover:bg-black rounded-none py-6 px-8 text-base opacity-0 animate-fade-in"
